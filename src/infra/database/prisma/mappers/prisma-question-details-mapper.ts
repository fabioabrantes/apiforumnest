...
export class PrismaQuestionDetailsMapper {
  static convertToQuestionDetailsDomain(raw: PrismaQuestionDetails): QuestionDetails {
    return QuestionDetails.create({
      ...
      attachments: raw.attachments.map(PrismaAttachmentMapper.convertToAttachmentDomain),
